...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_1 = "test/program1.bl",
            ...
            FILE_NAME_6 = "test/program6.bl", FILE_NAME_7 = "test/program6.bl";
    ...
    /**
     * Test of parse on syntactically invalid input. The name of the instruction
     * does equal the endName of the instruction.
     */
    @Test(expected = RuntimeException.class)
    ...
    /**
     * Test of parse on syntactically invalid input. The name of an instruction
    ...
    /**
     * Test of parse on syntactically invalid input. The body of the program
